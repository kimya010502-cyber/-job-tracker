/* ============================================================================
 * 줍줍 디자인 시스템 정리 — 스크립트 15c
 * Input 아이콘 슬롯 검증 (읽기 전용)
 *
 ...
 *
 * 대상: Input 컴포넌트 세트 1030:2017 (variant 3)
 *
 * 성공 조건
 *   - leading INSTANCE_SWAP 속성이 존재
 *   - 기본값이 Icon / Search 를 가리킴 (노드 id 또는 컴포넌트 key — 형태는 단정하지 않는다)
 *   - 3개 variant 모두 leading 이 INSTANCE 이고 16×16 이며 숨김
 *   - 외곽 240×36 · padding 0/12/0/12 · gap 8 유지
 *
 * 참고만 하는 값 (성공 조건 아님)
 *   - instanceCountRecursive — findAll 이 인스턴스 내부까지 재귀하므로 숫자가 커질 수 있다
 * ========================================================================== */

const SCRIPT_VERSION = '15c-v1-input-verify';

const SET_ID = '1030:2017';
const SET_NAME = 'Input';
const PROP_NAME = 'leading';
const DEFAULT_ICON = 'Icon / Search';
const SLOT = 16;
const EXPECT = { width: 240, height: 36, padding: '0/12/0/12', gap: 8, variantCount: 3, slotVisible: false };
